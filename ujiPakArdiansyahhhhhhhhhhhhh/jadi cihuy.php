...
<body>
    ...
    if (isset($_SESSION['peminjaman_buku'])) {
        ...
        echo "<table border='1'>";
        echo "<tr><th>No.</th><th>Nama Peminjam</th><th>Jenis Buku</th><th>Jlh</th><th>Tarif</th><th>Bayar sewa</th><th>Action</th> </tr>";
        $no = 1;
        foreach ($_SESSION['peminjaman_buku'] as $index => $row) {
            ...
            echo "<td><input type='checkbox' name='action[]' value='" . $index . "'></td>";  // Combined Checkbox
            echo "</tr>";
            $no++;
        }
        echo "</table>";
        echo "<td><input type='submit' name='submit_action' value='Submit Action'>  <!-- Updated Submit Button --></td>";
        echo "</form>";
